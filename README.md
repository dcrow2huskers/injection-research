...
### A Comparative Security Study of GPT, Copilot, and Claude

## 📌 Overview
This repository contains the research, experimental setup, datasets, and analysis for a study examining **injection vulnerabilities** in **LLM-generated code**. The goal is to understand whether and how modern AI coding tools—**OpenAI GPT**, **GitHub Copilot**, and **Anthropic Claude**—produce insecure Python and Java code that is susceptible to injection attacks.

The project uses a controlled set of **20 prompts** (naïve, security-aware) and applies static + dynamic analysis to measure vulnerability frequency, patterns, and severity.
...
- Compare vulnerability patterns across:
  - **Models:** GPT vs. Copilot vs. Claude  
...
#### **C. Language-Specific Prompts (6 total)**
Python-specific and Java-specific tasks, each with insecure and secure variants.  
Purpose: detect language-dependent model weaknesses.
...
- **Semgrep** (Python + Java)
- **FindSecBugs** (Java)
- Custom regex-style detectors for injection sinks
